...
public interface EntityGetApi {
    ...
    @ApiOperation(value = "Get the entityMetadata for the indicated external entity belonging to a determined set.", nickname = "entityGet", notes = "Get ...", response = EntityMetadata.class, tags={ "ConfigManager", })
    @ApiResponses(value = { 
