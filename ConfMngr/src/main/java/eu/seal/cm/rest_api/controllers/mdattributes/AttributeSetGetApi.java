...
public interface AttributeSetGetApi {
    ...
    @ApiOperation(value = "Get the attribute set for the profile just specified.", nickname = "attributeSetGet", notes = "Get ...", response = AttributeTypeList.class, tags={ "ConfigManager", })
    @ApiResponses(value = { 
